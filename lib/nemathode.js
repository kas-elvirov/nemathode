...
var evaluateAstWithInitialState = function evaluateAstWithInitialState(ast, config) {
  return evaluateAst(_objectSpread__default['default']({}, INITIAL_STATE), ast, config);
};
...
var _Nemathode = function _Nemathode(config) {
  ...
  this.evaluate = function (expression) {
    var ast = getAst(expression, _objectSpread__default['default']({}, _this.config));
    var result = evaluateAstWithInitialState([].concat(ast), _objectSpread__default['default']({}, _this.config));
    return result;
  };
